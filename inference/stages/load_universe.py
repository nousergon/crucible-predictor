...
# ── Universe membership resolution (alpha-engine-config-I4818 / I6495) ───────
#
...
#
# Regression (alpha-engine-config-I6495): crucible-predictor#422 (2026-07-31)
# deleted this chokepoint while claiming a signals-helper consolidation. Restore
# here keeps the shared ``nousergon_lib.signals`` helpers and the membership
# path; a structural CI guard fails if this block is deleted again.
...
def load_watchlist(
    ...
    """
    Build a focused prediction universe from Research's membership cut or signals.

    Resolution for ``path="auto"`` (alpha-engine-config-I4818 / I6495):
